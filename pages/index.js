    ...
    return (
      <div className="user-details">
        ...
        <div className="transaction-btns">
          ...
          <button onClick={burnTokens} className="burn-btn">Burn 1 ETH</button> {/* New button for burning tokens */}
        </div>
  ...
  return (
    <div className="full-screen">
      ...
      <style jsx global>{`
        ...
        .connect-btn, .deposit-btn, .withdraw-btn, .burn-btn {
        ...
        .connect-btn:hover, .deposit-btn:hover, .withdraw-btn:hover, .burn-btn:hover {
